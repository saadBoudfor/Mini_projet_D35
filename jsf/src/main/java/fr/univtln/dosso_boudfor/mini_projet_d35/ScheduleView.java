...
public class ScheduleView implements Serializable {
    ...
    public void init() {
        ...
        List<Task> tasks = taskBeanEJB.getTasksNotExpiredByUser(userController.getUserId());
        int i = 1;
        for(Task task:tasks){
            eventModel.addEvent(new DefaultScheduleEvent(task.getTitre(),addHour(i),addHour(i+1)));
            i++;
        }
